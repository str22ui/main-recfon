...
<body>
    <div class="mx-5 mt-2 md:mt-24 mb-10  ">
        <h1 class=" text-center">Clock In Dinas`</h1>
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('user.storeClockinDinas') }}" enctype="multipart/form-data"
            ...
            <div class="text-blue-700 mx-5  ">
                ...
                <input type="block" id="clockIn" name="clockIn">

                
                <div class="mb-5 relative">
                    <label for="typeWork" class="form-label block mb-2 text-sm font-medium">Perjalanan Dinas</label>
                    <div class="input-with-icon">
                        <input type="text" id="businessTrip" name="businessTrip"
                            class="form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pl-10 "
